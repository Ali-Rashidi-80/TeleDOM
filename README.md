...
> **TeleDOM v4 Official Release:** TeleDOM is a production-grade **Temporal Browser Intelligence Engine**:
> every important claim is backed by evidence, confidence, provenance and machine-verifiable proof.
> Featuring **306 agent-facing MCP tools** (100 `td_*` intelligence tools + 54 `dt_*` DevTools tools + 31 `fx_*` forensic tools + 121 core/v3 tools).
> 
> 📖 **[Complete 306 Tools English Catalog](./docs/TOOLS_CATALOG_306_EN.md)** | **[کاتالوگ جامع ۳۰۶ ابزار به زبان فارسی](./docs/TOOLS_CATALOG_306_FA.md)**
