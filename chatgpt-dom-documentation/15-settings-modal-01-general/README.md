# مستندات تب تنظیمات: عمومی (General)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **عمومی (General)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![General Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب General:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب General:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب General
