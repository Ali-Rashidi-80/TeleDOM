# مستندات تب تنظیمات: اعلان‌ها (Notifications)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **اعلان‌ها (Notifications)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Notifications Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Notifications:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Notifications:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Notifications
