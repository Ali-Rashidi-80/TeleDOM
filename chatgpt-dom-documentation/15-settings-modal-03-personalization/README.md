# مستندات تب تنظیمات: شخصی‌سازی و رفتار (Personalization)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **شخصی‌سازی و رفتار (Personalization)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Personalization Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Personalization:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Personalization:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Personalization
