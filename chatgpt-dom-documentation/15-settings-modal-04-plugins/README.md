# مستندات تب تنظیمات: پلاگین‌ها و ابزارها (Plugins)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **پلاگین‌ها و ابزارها (Plugins)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Plugins Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Plugins:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Plugins:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Plugins
