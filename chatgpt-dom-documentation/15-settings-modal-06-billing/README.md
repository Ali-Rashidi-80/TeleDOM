# مستندات تب تنظیمات: صورت‌حساب و اشتراک (Billing & Subscriptions)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **صورت‌حساب و اشتراک (Billing & Subscriptions)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Billing & Subscriptions Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Billing & Subscriptions:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Billing & Subscriptions:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Billing & Subscriptions
