# مستندات تب تنظیمات: میزان مصرف و سهمیه‌ها (Usage & Quotas)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **میزان مصرف و سهمیه‌ها (Usage & Quotas)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Usage & Quotas Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Usage & Quotas:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Usage & Quotas:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Usage & Quotas
