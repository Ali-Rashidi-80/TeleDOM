# مستندات تب تنظیمات: تحلیل‌ها و آمار (Analytics)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **تحلیل‌ها و آمار (Analytics)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Analytics Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Analytics:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Analytics:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Analytics
