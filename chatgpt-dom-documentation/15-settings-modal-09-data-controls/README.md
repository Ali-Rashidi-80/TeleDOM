# مستندات تب تنظیمات: کنترل داده‌ها و سوابق (Data Controls & History)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **کنترل داده‌ها و سوابق (Data Controls & History)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Data Controls & History Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Data Controls & History:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Data Controls & History:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Data Controls & History
