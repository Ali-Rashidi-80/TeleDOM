# مستندات تب تنظیمات: حافظه و فایل‌ها (Storage & Memory)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **حافظه و فایل‌ها (Storage & Memory)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Storage & Memory Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Storage & Memory:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Storage & Memory:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Storage & Memory
