# مستندات تب تنظیمات: ایمنی و حریم خصوصی (Safety & Privacy)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **ایمنی و حریم خصوصی (Safety & Privacy)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Safety & Privacy Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Safety & Privacy:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Safety & Privacy:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Safety & Privacy
