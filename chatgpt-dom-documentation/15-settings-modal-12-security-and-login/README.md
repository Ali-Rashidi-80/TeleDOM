# مستندات تب تنظیمات: امنیت، MFA و لاگین (Security & Login)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **امنیت، MFA و لاگین (Security & Login)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Security & Login Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Security & Login:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Security & Login:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Security & Login
