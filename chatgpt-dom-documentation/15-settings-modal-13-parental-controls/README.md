# مستندات تب تنظیمات: کنترل والدین (Parental Controls)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **کنترل والدین (Parental Controls)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Parental Controls Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Parental Controls:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Parental Controls:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Parental Controls
