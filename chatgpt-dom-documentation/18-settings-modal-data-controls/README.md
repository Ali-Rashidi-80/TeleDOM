# مستندات دام: 18-settings-modal-data-controls

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای بخش **18-settings-modal-data-controls** می‌باشد.

---

## 📌 تصویر واقعی از محیط زنده (Real Snapshot):
![18-settings-modal-data-controls Screenshot](screenshot.png)

---

## 🎯 سلکتورهای کلیدی:
- **سلکتور کانتینر:** `div[data-testid="18-settings-modal-data-controls"], main, div.stage-layout`
