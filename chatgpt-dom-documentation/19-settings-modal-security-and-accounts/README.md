# مستندات دام: 19-settings-modal-security-and-accounts

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای بخش **19-settings-modal-security-and-accounts** می‌باشد.

---

## 📌 تصویر واقعی از محیط زنده (Real Snapshot):
![19-settings-modal-security-and-accounts Screenshot](screenshot.png)

---

## 🎯 سلکتورهای کلیدی:
- **سلکتور کانتینر:** `div[data-testid="19-settings-modal-security-and-accounts"], main, div.stage-layout`
