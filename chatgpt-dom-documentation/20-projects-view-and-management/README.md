# مستندات تب تنظیمات: نمای پروژه‌ها و مدیریت پروژه‌ها (Projects View)

این پوشه شامل ساختار کامل DOM، استایل‌های محاسبه‌شده، تصاویر واقعی و راهنمای تزریق UI برای تب **نمای پروژه‌ها و مدیریت پروژه‌ها (Projects View)** در دیالوگ تنظیمات رسمی ChatGPT می‌باشد.

---

## 📌 تصویر واقعی تب (Real Screenshot):
![Projects View Tab](screenshot.png)

---

## 🎯 سلکتورهای کلیدی تب Projects View:
...
## 🛠️ راهنمای تزریق UI سفارشی در تب Projects View:

```javascript
// تزریق بخش تنظیمات سفارشی به انتهای تب Projects View
