# مستندات چت زنده: مقایسه مکمل راهب
### Chat Thread #11: thread-11-moghayese-mokamel-raheb

- **دسته‌بندی محتوایی:** Comparison Tables & Lists
- **آدرس مستقیم در پلتفرم:** `https://chatgpt.com/c/6a9c499f-8310-83ed-bf90-f4eb6d0e43b6`
- **تاریخ استخراج زنده:** 2026-09-09T14:23:47.360Z

---

## 📌 تصویر واقعی از این گفت‌وگو (Real Live Snapshot):
![مقایسه مکمل راهب Screenshot](screenshot.png)
