# مستندات چت زنده: تحلیل پرامپت حرفه‌ای ۲
### Chat Thread #13: thread-13-tahlil-prompt-v2

- **دسته‌بندی محتوایی:** Prompt Analysis & JSON Output
- **آدرس مستقیم در پلتفرم:** `https://chatgpt.com/c/6a9a1e2d-bdbc-83ed-97b2-4355183e3b15`
- **تاریخ استخراج زنده:** 2026-09-09T14:24:22.947Z

---

## 📌 تصویر واقعی از این گفت‌وگو (Real Live Snapshot):
![تحلیل پرامپت حرفه‌ای ۲ Screenshot](screenshot.png)
