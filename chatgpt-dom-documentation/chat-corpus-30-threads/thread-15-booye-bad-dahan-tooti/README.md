# مستندات چت زنده: بوی بد دهان طوطی
### Chat Thread #15: thread-15-booye-bad-dahan-tooti

- **دسته‌بندی محتوایی:** Medical & Diagnostic Guides
- **آدرس مستقیم در پلتفرم:** `https://chatgpt.com/c/6a997008-3a44-83eb-bab0-2653d1c82810`
- **تاریخ استخراج زنده:** 2026-09-09T14:25:04.450Z

---

## 📌 تصویر واقعی از این گفت‌وگو (Real Live Snapshot):
![بوی بد دهان طوطی Screenshot](screenshot.png)
