# مستندات چت زنده: تحلیل پرامپت حرفه‌ای ۷
### Chat Thread #23: thread-23-tahlil-prompt-v7

- **دسته‌بندی محتوایی:** System Instructions & Persona
- **آدرس مستقیم در پلتفرم:** `https://chatgpt.com/c/6a96bdc6-14e8-83eb-91ae-e7019abe279f`
- **تاریخ استخراج زنده:** 2026-09-09T14:28:58.481Z

---

## 📌 تصویر واقعی از این گفت‌وگو (Real Live Snapshot):
![تحلیل پرامپت حرفه‌ای ۷ Screenshot](screenshot.png)
