# مستندات چت زنده: پروژه پرامپت wp03 T3
### Chat Thread #25: thread-25-project-prompt-wp03-t3

- **دسته‌بندی محتوایی:** Project Custom Workspace
- **آدرس مستقیم در پلتفرم:** `https://chatgpt.com/g/g-p-6a8c072ba8f08191b0da321d2712e03b/project`
- **تاریخ استخراج زنده:** 2026-09-09T14:29:48.680Z

---

## 📌 تصویر واقعی از این گفت‌وگو (Real Live Snapshot):
![پروژه پرامپت wp03 T3 Screenshot](screenshot.png)
