...
## ابزارهای عمومی پلتفرم و کنترل مرورگر (95 ابزار)
...
## بازرسی زنده DOM و ناظر تغییرات (Live Inspection & Observer) (15 ابزار)
...
## هدف‌گیری هوشمند و تعامل مقاوم (Targeting & Interaction) (4 ابزار)
...
## بازرسی خودکار و مدیریت حوادث (Autonomous Investigation) (3 ابزار)
