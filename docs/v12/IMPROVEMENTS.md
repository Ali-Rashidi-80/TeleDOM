# TeleDOM v12 — Improvement Matrix (106 improvements)

> GENERATED from `src/v12/registry/improvements.ts` — the count, fields and statuses
> are validated by `tests/v12/registry-integration.test.ts`. Hand-editing this
...
| ID | Title | Problem → Solution | Priority | Version | Status |
|---|---|---|---|---|---|
| M01 | **Intelligence-domain-oriented module structure** | Feature-oriented src/ mixed concerns → src/v12/ with 18 domain modules, each with public barrel + typed exports | P1 | 4.0 | IMPLEMENTED |
...
| M04 | **Authoritative version registry** | Version strings drifted (v2.1.0 banner vs 3.1.0 package) → src/v12/version.ts: TELEDOM_VERSION + VERSION_HISTORY (v4→v12); sea-entry banner derives from it | P0 | 12.0 | IMPLEMENTED |
| M09 | **Directory-import-free kernel modules** | Barrel imports broke direct Node execution → Explicit file-relative imports within v12 where scripts consume them | P2 | 12.0 | IMPLEMENTED |
...
- **Tests**: tests/v12/kernel.test.ts (invariant test)
...
- **Tests**: tests/v12/kernel.test.ts (tamper test)
- **Benchmark**: n/a
...
- **Tests**: tests/v12/kernel.test.ts (6 admission tests)
- **Benchmark**: n/a
...
- **Tests**: tests/v12/kernel.test.ts (monotonic + regression)
...
- **Tests**: tests/v12/temporal.test.ts (stateAt meta)
- **Benchmark**: n/a
...
- **Tests**: tests/v12/temporal.test.ts
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/temporal.test.ts (join + entity scoping)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/temporal.test.ts (branch + original-untouched)
...
- **Tests**: tests/v12/evidence-causality.test.ts
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/temporal.test.ts (100K scale)
...
- **Tests**: tests/v12/evidence-causality.test.ts (5 confidence tests)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/evidence-causality.test.ts (classification test)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/registry-integration.test.ts
...
- **Tests**: tests/v12/evidence-causality.test.ts (chain test)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/evidence-causality.test.ts + golden suite
...
- **Tests**: tests/v12/evidence-causality.test.ts (3 counterfactual tests)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12 golden suite (false success 0.00%)
...
- **Tests**: tests/v12 registry smoke
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/evidence-causality.test.ts (bounded graph test)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/kernel.test.ts (identity tests)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/security-resilience.test.ts (semantic tests)
- **Benchmark**: n/a
...
- **Tests**: tests/v12/security-resilience.test.ts
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/security-resilience.test.ts (lifecycle test)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/security-resilience.test.ts (targeting tests)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12/evidence-causality.test.ts (4 verification tests)
...
- **Tests**: tests/v12/incident-investigation.test.ts (4 mutation tests)
- **Benchmark**: n/a
- **Security**: none
...
- **Tests**: tests/v12 registry smoke (status taxonomy)
...
- **Tests**: tests/v12 .tdom tests (round-trip, gzip, tamper)
- **Benchmark**: n/a
...
- **Tests**: tests/v12 §78 end-to-end test
- **Benchmark**: ICR=100%
- **Security**: investigation latency benchmark
...
- **Modules**: tests/v12/suite-reports, registry/improvements
- **Complexity**: low · **Risk**: low
...
- **Architecture**: src/v12/ with 18 domain modules, each with public barrel + typed exports
- **Modules**: src/v12/*
- **Complexity**: medium · **Risk**: medium
...
- **Why it matters**: v12 kernel must sit UNDER existing dt_/fx_/base surfaces without breaking them
...
- **Architecture**: src/v12/version.ts: TELEDOM_VERSION + VERSION_HISTORY (v4→v12); sea-entry banner derives from it
...
- **Architecture**: Explicit file-relative imports within v12 where scripts consume them
- **Modules**: src/v12/*
- **Complexity**: low · **Risk**: low
