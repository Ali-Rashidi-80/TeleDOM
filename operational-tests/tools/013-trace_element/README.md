# Operational Test: `trace_element`
...
- [x] **Traces complete lifecycle of button 10 from creation to removal**: targetNodeId, tagName, selectorHint, initialAttributes, createdAt, createdSequence, createdEventId, removedAt, removedSequence, removedEventId, isCurrentlyAlive, lifespanMs, mutationCount, entries, correlatedDiagnostics, correlatedNetwork
