# Operational Test: `get_live_dom_snapshot`
...
## Test Objective
Captures full live virtual DOM snapshot in HTML format

## Raw Transmitted JSON-RPC Request
```json
{
  "jsonrpc": "2.0",
  "id": "op_req_045_get_live_dom_snapshot",
  "method": "tools/call",
  "params": {
...
- [x] **Captures full live virtual DOM snapshot in HTML format**: Received valid payload content
