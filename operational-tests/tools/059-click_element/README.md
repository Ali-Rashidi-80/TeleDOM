# Operational Test: `click_element`
...
## Test Objective
Clicks element in explicit normal mode with measured effects

## Raw Transmitted JSON-RPC Request
```json
{
  "jsonrpc": "2.0",
  "id": "op_req_059_click_element",
  "method": "tools/call",
  "params": {
    "name": "click_element",
    "arguments": {
...
- [x] **Clicks element in explicit normal mode with measured effects**: success, action, target, beforeState, afterState, effects, durationMs, stabilized
