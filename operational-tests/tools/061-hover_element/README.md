# Operational Test: `hover_element`
...
## Test Objective
Hovers element with pointer event sequence

## Raw Transmitted JSON-RPC Request
```json
{
  "jsonrpc": "2.0",
  "id": "op_req_061_hover_element",
  "method": "tools/call",
  "params": {
    "name": "hover_element",
    "arguments": {
...
- [x] **Hovers element with pointer event sequence**: success, action, target, beforeState, afterState, effects, durationMs, stabilized
