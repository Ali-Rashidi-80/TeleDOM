# Operational Test: `capture_page_region`
...
## Test Objective
Captures region with OBSERVED/USER/INTENDED/VERIFICATION separation

## Raw Transmitted JSON-RPC Request
```json
{
  "jsonrpc": "2.0",
  "id": "op_req_107_capture_page_region",
  "method": "tools/call",
  "params": {
...
- [x] **Captures region with OBSERVED/USER/INTENDED/VERIFICATION separation**: observed, user, intendedChange, verification, analysis
