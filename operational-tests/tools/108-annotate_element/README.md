# Operational Test: `annotate_element`
...
## Test Objective
Annotates element into project region

## Raw Transmitted JSON-RPC Request
```json
{
  "jsonrpc": "2.0",
  "id": "op_req_108_annotate_element",
  "method": "tools/call",
  "params": {
...
- [x] **Annotates element into project region**: observed, user, analysis
