# Operational Test: `get_region_annotation`
...
## Test Objective
Loads the most recently captured region annotation

## Raw Transmitted JSON-RPC Request
```json
{
  "jsonrpc": "2.0",
  "id": "op_req_110_get_region_annotation",
  "method": "tools/call",
  "params": {
...
- [x] **Loads the most recently captured region annotation**: observed, user, analysis
