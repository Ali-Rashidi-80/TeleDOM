# Operational Test: `td_cause_dependency`
...
{
  "jsonrpc": "2.0",
  "id": "op_req_234_td_cause_dependency",
  "method": "tools/call",
  "params": {
    "name": "td_cause_dependency",
    "arguments": {
...
- [x] **Returns a structured v12 intelligence result with honest status taxonomy (PASS/INCONCLUSIVE/DEGRADED/UNSUPPORTED)**: status, dependsOnEvents, eventCount, tool, capability
