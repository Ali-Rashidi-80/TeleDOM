# Operational Test: `td_component_map`
...
{
  "jsonrpc": "2.0",
  "id": "op_req_239_td_component_map",
  "method": "tools/call",
  "params": {
    "name": "td_component_map",
    "arguments": {
...
- [x] **Returns a structured v12 intelligence result with honest status taxonomy (PASS/INCONCLUSIVE/DEGRADED/UNSUPPORTED)**: status, componentCount, components, tool, capability
