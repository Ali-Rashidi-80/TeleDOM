...
```json
{
  ...
  "result": {
    "content": [
      {
        "type": "text",
        "text": "{\"status\":\"INCONCLUSIVE\",\"note\":\"session has no events to mutate\",\"tool\":\"td_simulate_change\",\"capability\":{\"version\":\"4.1.0\",\"category\":\"counterfactual-simulation\",\"securityClass\":\"read-only\"}}"
      }
    ],
    "isError": false
  }
