# Operational Test: `td_memory_leak_trace`
...
{
  "jsonrpc": "2.0",
  "id": "op_req_292_td_memory_leak_trace",
  "method": "tools/call",
  "params": {
    "name": "td_memory_leak_trace",
    "arguments": {
...
- [x] **Returns a structured v12 intelligence result with honest status taxonomy (PASS/INCONCLUSIVE/DEGRADED/UNSUPPORTED)**: status, growthDetected, domEventCount, unmountRatio, note, tool, capability
