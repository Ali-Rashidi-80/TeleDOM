# Operational Test: `td_retention_graph`
...
{
  "jsonrpc": "2.0",
  "id": "op_req_293_td_retention_graph",
  "method": "tools/call",
  "params": {
    "name": "td_retention_graph",
    "arguments": {
...
- [x] **Returns a structured v12 intelligence result with honest status taxonomy (PASS/INCONCLUSIVE/DEGRADED/UNSUPPORTED)**: status, reason, experimental, tool, capability
