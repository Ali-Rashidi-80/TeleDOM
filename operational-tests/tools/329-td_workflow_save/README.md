# Operational Test: `td_workflow_save`
...
{
  "jsonrpc": "2.0",
  "id": "op_req_329_td_workflow_save",
  "method": "tools/call",
  "params": {
    "name": "td_workflow_save",
    "arguments": {
      "workflow": {
...
```json
{
  ...
  "result": {
    "content": [
      {
        "type": "text",
        "text": "{\"status\":\"PASS\",\"saved\":{\"name\":\"extension_smoke_test\",\"version\":\"1.0.0\",\"steps\":5,\"versions\":1},\"note\":\"stored verbatim — TeleDOM does not interpret workflow semantics\",\"tool\":\"td_workflow_save\",\"capability\":{\"version\":\"4.1.0\",\"category\":\"workflow-runtime\",\"securityClass\":\"reversible\"}}"
      }
    ],
    "isError": false
  }
