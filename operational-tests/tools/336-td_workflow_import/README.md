# Operational Test: `td_workflow_import`
...
{
  "jsonrpc": "2.0",
  "id": "op_req_336_td_workflow_import",
  "method": "tools/call",
  "params": {
    "name": "td_workflow_import",
    "arguments": {
      "export": {
        "current": {
          "schema": "teledom.agent-workflow/1.0",
          "id": "wf-op-extension-smoke-v1",
          "name": "extension_smoke_test_imported",
          "version": "1.0.0",
...
```json
{
  ...
  "result": {
    "content": [
      {
        "type": "text",
        "text": "{\"status\":\"PASS\",\"imported\":{\"name\":\"extension_smoke_test_imported\",\"version\":\"1.0.0\",\"versions\":1},\"tool\":\"td_workflow_import\",\"capability\":{\"version\":\"4.1.0\",\"category\":\"workflow-runtime\",\"securityClass\":\"reversible\"}}"
      }
    ],
    "isError": false
  }
...
- [x] **Returns a structured v4 intelligence result with honest status taxonomy (PASS/INCONCLUSIVE/DEGRADED/UNSUPPORTED)**: status, imported, tool, capability
