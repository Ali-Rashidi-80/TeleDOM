/**
 * TeleDOM v4 — docs generator: renders docs/intelligence/IMPROVEMENTS.md,
...
function renderImprovementsMd(): string {
  ...
  let md = `# TeleDOM v4 — Improvement Matrix (${validation.count} improvements)\n\n`;
  md += `> GENERATED from \`src/intelligence/registry/improvements.ts\` — the count, fields and statuses\n>`;
  md += ` are validated by \`tests/intelligence/registry-integration.test.ts\`. Hand-editing this\n`;
...
function renderCapabilitiesMd(): string {
  ...
  let md = `# TeleDOM v4 — Capability Surface (generated)\n\n`;
...
function renderCompatibilityMd(): string {
  ...
  let md = `# TeleDOM v4 — Compatibility Matrix (generated)\n\n`;
...
function renderVersionHistoryMd(): string {
  let md = `# TeleDOM v4 → v4+ Version Progression\n\n`;
