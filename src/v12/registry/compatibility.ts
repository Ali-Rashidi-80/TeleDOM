/**
 * TeleDOM v12+ Registry — Generated compatibility matrix.
 *
...
/**
 * The v12 td_* surface is fully implemented in the v12 kernel with
 * simulation support. Legacy surfaces (dt_/fx_/base, 206 tools) remain
 * compatibility layers over the pre-v12 runtime; their parity is
...
export function generateCompatibilityMatrix(): CompatibilityMatrix {
  const rows: CompatibilityRow[] = CAPABILITY_REGISTRY.map((cap) => ({
    ...
    implementation: `src/v12 (${cap.dependencies.join(' + ')})`,
