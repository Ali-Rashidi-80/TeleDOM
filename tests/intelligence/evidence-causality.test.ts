/**
 * TeleDOM v4 evidence + causality + verification tests.
...
import { EvidenceGraph } from '../../src/intelligence/evidence/graph';
import { assessConfidence } from '../../src/intelligence/evidence/confidence';
import { CausalEngine } from '../../src/intelligence/causality/engine';
import { EventMesh, EventEnvelope } from '../../src/intelligence/kernel';
import { VerificationEngine, ProofEngine } from '../../src/intelligence/verification';
import { CounterfactualEngine } from '../../src/intelligence/simulation';
import { PredictionEngine } from '../../src/intelligence/simulation';
...
describe('v4 confidence — evidence before assertions', () => {
...
describe('v4 causal engine — correlation ≠ causation', () => {
...
describe('v4 verification — no synthetic success', () => {
...
describe('v4 counterfactual — what-if debugging', () => {
...
describe('v4 prediction — guesses are never facts', () => {
