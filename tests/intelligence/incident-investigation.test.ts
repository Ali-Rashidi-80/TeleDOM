/**
 * TeleDOM v4 incident + investigation + .tdom tests — including the
...
import { IncidentManager, AutonomousInvestigator, TdomFormat } from '../../src/intelligence/incident';
import { TeleDOMPlatform } from '../../src/intelligence/platform';
import { SafeMutationEngine, MutationPlan, MutationScope } from '../../src/intelligence/mutation';
...
describe('v4 incident lifecycle', () => {
...
describe('v4 autonomous investigation (§78 final self-challenge core)', () => {
...
describe('v4 .tdom portable format', () => {
...
describe('v4 safe mutation transactions', () => {
