/**
 * TeleDOM v4 kernel tests — event integrity is P0.
...
import { EventMesh, HybridClock, HashChain, computeHash, IdentityEngine } from '../../src/intelligence/kernel';

describe('v4 kernel — HybridClock', () => {
...
describe('v4 kernel — HashChain integrity', () => {
...
describe('v4 kernel — EventMesh (P0 event integrity)', () => {
  ...
  it('missing events are detected as gaps; late events are admitted and flagged', () => {
    const mesh = new EventMesh();
    const raw = (seq: number, type: string): import('../../src/intelligence/kernel').EventEnvelope => {
...
describe('v4 kernel — IdentityEngine', () => {
