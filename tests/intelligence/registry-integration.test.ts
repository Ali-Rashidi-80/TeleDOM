...
import { CAPABILITY_REGISTRY, registryStats, validateRegistry, capabilityById } from '../../src/intelligence/registry/capabilities';
import { TELEDOM_INTELLIGENCE_TOOLS, TD_TOOL_NAMES } from '../../src/intelligence/registry/td-tools';
import { generateCompatibilityMatrix } from '../../src/intelligence/registry/compatibility';
...
import { TELEDOM_VERSION, VERSION_HISTORY } from '../../src/intelligence/version';
import { generateGoldenSuite, runGoldenSuite, GOLDEN_CATEGORIES } from '../../src/intelligence/golden/generator';
import { runChaosSuite } from '../../src/intelligence/chaos/chaos';
...
describe('v4 golden incident suite (1000+ deterministic incidents)', () => {
...
describe('v4 chaos engineering — failure is contained, observed, explained, recoverable', () => {
