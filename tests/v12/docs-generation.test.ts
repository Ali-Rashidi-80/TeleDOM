/**
 * TeleDOM v12+ — generated docs test: renders docs/v12/*.md from the
...
import { validateImprovements, IMPROVEMENTS } from '../../src/v12/registry/improvements';
import { renderImprovementsMd, renderCapabilitiesMd, renderCompatibilityMd, renderVersionHistoryMd } from '../../src/v12/registry/docs-generator';
import { CAPABILITY_REGISTRY } from '../../src/v12/registry/capabilities';

describe('v12 improvement matrix (100+ requirement)', () => {
  ...
  it('renders docs/v12/*.md from the registries', () => {
