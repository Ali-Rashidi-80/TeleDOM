/**
 * TeleDOM v12+ temporal tests — the temporal engine as first-class
...
import { TemporalEngine } from '../../src/v12/temporal/queries';
import { IndexedEventStore } from '../../src/v12/temporal/event-store';
import { BranchManager } from '../../src/v12/temporal/branching';
import { StateFrameBuilder, ChunkStore } from '../../src/v12/temporal/state-frame';
...
describe('v12 temporal — State(T) & Seek', () => {
...
describe('v12 temporal — Diff(T1,T2)', () => {
...
describe('v12 temporal — Trace(Entity) & Join(Signals)', () => {
...
describe('v12 temporal — FirstChange / LastStable / Window', () => {
...
describe('v12 temporal — StateFrame chunks', () => {
...
describe('v12 temporal — Branching never overwrites reality', () => {
...
describe('v12 temporal — 100K event scale', () => {
